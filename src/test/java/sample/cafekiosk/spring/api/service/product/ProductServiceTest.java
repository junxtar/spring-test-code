...
class ProductServiceTest extends IntegrationTestSupport {
    ...
    @DisplayName("신규 상품을 등록한다. 상품번호는 가장 최근 상품의 상품번호에 1 증가한 값이다.")
    @Test
    void createProduct() {
        // given
        Product product = createProduct("001", SELLING, HANDMADE, "아메리카노", 4000);
    ...
    @DisplayName("신규 상품을 등록한다. 상품번호는 아직 아무 상품이 등록이 안되어있으므로 001이다")
    @Test
